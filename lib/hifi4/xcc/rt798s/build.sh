...
export XTENSA_SYSTEM="/opt/xtensa/XtDevTools/install/builds/RI-2023.11-linux/rt700_hifi4_RI23_11_nlib/config"
export XTENSA_TOOLS_VERSION="RI-2023.11-linux"
export XTENSA_CORE="rt700_hifi4_RI23_11_nlib"

git clone https://github.com/tensorflow/tflite-micro.git tflite-micro
cd tflite-micro
git checkout 3200ccd18268346d0ea965720c5599a3d051e85
